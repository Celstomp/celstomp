  ...
  <div id="shortcutsModal" class="modalCard" role="dialog" aria-modal="true" aria-labelledby="shortcutsModalTitle" hidden>
    ...
    <div class="shortcutsGrid">
      <div class="shortcutSection">
        ...
        <div class="shortcutRow"><kbd>5</kbd><span>Text</span></div>
        <div class="shortcutRow"><kbd>6</kbd><span>Fill Brush</span></div>
        <div class="shortcutRow"><kbd>7</kbd><span>Fill Eraser</span></div>
        <div class="shortcutRow"><kbd>8</kbd><span>Lasso Fill</span></div>
        <div class="shortcutRow"><kbd>9</kbd><span>Lasso Erase</span></div>
        <div class="shortcutRow"><kbd>0</kbd><span>Rect Select</span></div>
      </div>
      <div class="shortcutSection">
        <h4>Navigation</h4>
